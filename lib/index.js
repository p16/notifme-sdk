...
var NotifmeSdk = function () {
  function NotifmeSdk(options) {
    ...
    this.sender = new _sender2.default([].concat((0, _toConsumableArray3.default)((0, _keys2.default)(CHANNELS)), (0, _toConsumableArray3.default)((0, _keys2.default)(providers))), providers, strategies);
  }
